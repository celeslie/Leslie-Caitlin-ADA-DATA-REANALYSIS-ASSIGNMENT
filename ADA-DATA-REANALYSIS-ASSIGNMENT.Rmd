...
Experiment 2 investigated the effects of each eye having a different imprint on both monocular and binocolur preference tests. The evaluated these results using a series of T-tests. My descriptive and inferentical statistical reanalyses evaluate the monocular test group of this experiment.
